...
This package is deprecated and we suggest to move [helm-swoop](https://github.com/emacsorphanage/helm-swoop) instead.
[helm-swoop](https://github.com/emacsorphanage/helm-swoop) is the successor to `swoop` and is well maintained.
